...
To give you a better idea of the underlying numbers, let's look at the Node Exporter.
The Node Exporter exposes metrics for every mounted filesystem. Every node will have
